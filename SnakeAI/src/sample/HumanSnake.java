...
//
//public class HumanSnake extends Application {
//
...
//  Board[] boards = new Board[numThreads];
//
...
//  }
//
//  private void startSnakeAI() {
//    for (int i = 0; i < numThreads; i++) {
//      boards[i] = new Board(HEIGHT, WIDTH);
//      threads[i] = new Thread(boards[i]);
//      threads[i].start();
//    }
//  }
//
